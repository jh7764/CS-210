...
public class Point3D implements Comparable<Point3D> {
    ...
    public double distance(Point3D other) {
        double xcomp= Math.pow((this.x - other.x), 2);
        double ycomp = Math.pow((this.y - other.y), 2);
        double zcomp = Math.pow((this.z - other.z), 2);
    ...
    public int compareTo(Point3D other) {
        double p1 = this.distance(new Point3D(0, 0, 0));
        double p2 = other.distance(new Point3D(0, 0, 0));
